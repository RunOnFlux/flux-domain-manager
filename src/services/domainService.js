...
async function generateAndReplaceKadenaApplicationHaproxyConfig() {
  try {
    ...
    let appLocationsNode = [{ ip: '54.39.237.205' }, { ip: '54.39.237.206' }, { ip: '54.39.237.207' }, { ip: '5.39.57.12' }, { ip: '5.39.57.13' }, { ip: '5.39.57.14' }]; // zelcore nodes
    ...
    let appLocationsData = [{ ip: '54.39.237.205' }, { ip: '54.39.237.206' }, { ip: '54.39.237.207' }, { ip: '5.39.57.12' }, { ip: '5.39.57.13' }, { ip: '5.39.57.14' }]; // zelcore nodes
